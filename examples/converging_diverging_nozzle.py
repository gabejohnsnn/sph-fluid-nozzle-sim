...
"""
Example of a converging-diverging nozzle simulation
"""
...
sim_config = {
    ...
    'time_step': 0.001,
    'gravity': [0.0, -0.5, 0.0],  # Reduced gravity for better visualization
    'bound_min': [-1.0, -5.0, -5.0],
    'bound_max': [15.0, 5.0, 5.0],
    'bound_damping': -0.5,
}

# Create fluid (water with increased viscosity for stability)
fluid = Fluid({
    'name': 'Viscous Water',
    'density': 1000.0,
    'viscosity': 0.01,  # Higher viscosity for stability
...
nozzle_config = {
    ...
    'throat_diameter': 0.5,
    'outlet_diameter': 1.0,
    'throat_position': 0.4,  # Throat is at 40% of the length
    'length': 4.0,
    'flow_rate': 20.0,
    'inflow_velocity': 8.0,
}
